...
exploreTypeFilter.addEventListener('change', applyExploreFilters);
budgetFilter.addEventListener('change', applyExploreFilters);
sortFilter.addEventListener('change', applyExploreFilters);
...
// Refresh filters when dropdowns are clicked
['countryFilter','stateFilter','cityFilter','exploreCountryFilter','exploreStateFilter','exploreCityFilter'].forEach(id => {
    const el = document.getElementById(id);
    if (el) {
        el.addEventListener('mousedown', loadCountryStateCityOptions);
    }
});
